        ...
        <ImageBackground
            ...
            <SafeAreaView style={styles.container}>
                ...
                <View style={styles.inputS}>
                    {/* <Text style={styles.formatInput}> Username</Text>                    
                        <TextInput 
                ...
                <View style={styles.inform}>
                    <Text style={styles.informText}> REGISTER </Text>
                    <Text style={styles.informTexts}> {`register for an account \n and get our best service for easier laundry`}</Text>
                </View>
            </SafeAreaView>
        </ImageBackground>
    )
